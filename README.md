...
A local file converter for the Omarchy Quattro bar. Drop or pick a file, choose
a target format, and it's converted on-device into `~/Downloads` — no cloud.
...
1. Drag a file onto the panel, or press **Choose file…** to pick one.
